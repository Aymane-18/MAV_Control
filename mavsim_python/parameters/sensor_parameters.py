...
abs_pres_sigma = 0.01*1000  # standard deviation in Pascals
abs_pres_bias = 0.125*1000
#-------- Pressure Sensor (Airspeed) --------
diff_pres_sigma = 0.002*1000  # standard deviation in Pascals
diff_pres_bias = 0.020*1000
